...
# to install requests to the IDE enter command 'pip install requests'

# checking for link in the apple itunes site and it will download a file in JSON format
